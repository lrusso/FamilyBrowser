package ar.com.lrusso.familybrowser.Database;
...
import ar.com.lrusso.familybrowser.View.GridItem;
...
public class RecordAction {
    ...
    public List<Record> listHistory() {
        ...
        cursor.moveToFirst();
        while (!cursor.isAfterLast()) {
            if (!cursor.getString(cursor.getColumnIndex(RecordUnit.COLUMN_URL)).startsWith("data"))
        	list.add(getRecord(cursor));
            cursor.moveToNext();
        }
        cursor.close();
